...
import app.akeorcist.deviceinformation.manager.InfoManager;
import app.akeorcist.deviceinformation.R;

public class CameraSubFragment extends Fragment {
	...
	public static CameraSubFragment newInstance(int cameraId) {
		CameraSubFragment fragment = new CameraSubFragment();
