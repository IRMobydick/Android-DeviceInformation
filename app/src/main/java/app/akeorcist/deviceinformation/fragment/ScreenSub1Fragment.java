...
public class ScreenSub1Fragment extends Fragment {
	ScrollView scrollScreen;
	LinearLayout layoutLoading;
	
	public static ScreenSub1Fragment newInstance() {
		ScreenSub1Fragment fragment = new ScreenSub1Fragment();
		return fragment;
	}

	public ScreenSub1Fragment() { }
