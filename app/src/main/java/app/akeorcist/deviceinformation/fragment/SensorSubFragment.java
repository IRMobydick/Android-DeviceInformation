...
@SuppressLint("NewApi")
public class SensorSubFragment extends Fragment {
	...
	public static SensorSubFragment newInstance(String name, String vendor, int type, String version
			, String power, String max_range, String resolution, String min_delay, String fifo_max, String fifo_reserved) {
		SensorSubFragment fragment = new SensorSubFragment();
