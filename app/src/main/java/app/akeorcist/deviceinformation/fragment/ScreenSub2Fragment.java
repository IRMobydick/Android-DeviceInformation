...
public class ScreenSub2Fragment extends Fragment {
	...
	public static ScreenSub2Fragment newInstance() {
		ScreenSub2Fragment fragment = new ScreenSub2Fragment();
		return fragment;
	}

	@SuppressLint("InlinedApi")
	public ScreenSub2Fragment() {
