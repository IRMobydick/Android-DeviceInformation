...
public class FeatureListViewAdapter extends ArrayAdapter<String> {
	ArrayList<String> arr_list; 
	LayoutInflater INFLATER;
	Context mContext;
    
	public FeatureListViewAdapter(Context context, int textViewResourceId, ArrayList<String> objects) {
